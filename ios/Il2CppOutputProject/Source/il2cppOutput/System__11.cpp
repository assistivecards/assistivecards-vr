...
IL_000c:
	{
		NullCheck(G_B2_0);
		bool L_2;
		L_2 = VirtualFuncInvoker0< bool >::Invoke(5, G_B2_0);
		return L_2;
	}
}
...
IL_000c:
	{
		NullCheck(G_B2_0);
		bool L_2;
		L_2 = VirtualFuncInvoker0< bool >::Invoke(6, G_B2_0);
		return L_2;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t DeflateStream_ReadCore_m58E605C082DCF3455C4D56EBEBB8F2ABECCC9B40 (DeflateStream_tF1758952E9DBAB2F9A15D42971F33A78AB4FC104* __this, Span_1_tDADAC65069DFE6B57C458109115ECD795ED39305 ___0_destination, const RuntimeMethod* method) 
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		int32_t L_0 = (&___0_destination)->____length;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DeflateStream_WriteCore_mC6ADF328D0A66CAFEEC9B23F89A22C223DFF3730 (DeflateStream_tF1758952E9DBAB2F9A15D42971F33A78AB4FC104* __this, ReadOnlySpan_1_tA850A6C0E88ABBA37646A078ACBC24D6D5FD9B4D ___0_source, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		int32_t L_1 = (&___0_source)->____length;
...
IL_0045:
	{
		bool L_10;
		L_10 = VirtualFuncInvoker0< bool >::Invoke(8, __this);
		if (L_10)
		{
			goto IL_0058;
		}
...
IL_0019:
	{
		bool L_4;
		L_4 = VirtualFuncInvoker0< bool >::Invoke(5, __this);
		if (L_4)
		{
			goto IL_002c;
		}
...
IL_0027:
	{
		NullCheck(G_B4_0);
		RuntimeObject* L_5;
		L_5 = VirtualFuncInvoker0< RuntimeObject* >::Invoke(14, G_B4_0);
...
IL_005b:
	{
		intptr_t L_12 = ___0_buffer;
		int32_t L_13 = V_1;
		*(&___0_buffer) = (((intptr_t)il2cpp_codegen_add(L_12, L_13)));
